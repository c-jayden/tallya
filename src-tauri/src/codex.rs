// Codex CLI integration: AI generation/analysis commands, prompt building,
// response parsing, and the CLI process plumbing. Split out of lib.rs so each
// concern stays focused. `suppress_console_window` lives in the crate root
// because it is shared with directory-reveal on Windows.
...
pub struct GenerateDailyMemoryInput {
    date: String,
    raw_content: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct DailyMemorySupplements {
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct GeneratedDailyMemory {
    #[serde(default)]
    summary: String,
    #[serde(default)]
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct GenerateWeeklyReportInput {
    start_date: String,
    end_date: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct GenerateRangeReportInput {
...
#[serde(rename_all = "camelCase")]
pub struct ReportStyleProfileInput {
    #[serde(default)]
    enabled: bool,
    #[serde(default)]
    summary: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct AnalyzeReportStyleInput {
    sample_text: String,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct AnalyzedReportStyle {
    #[serde(default)]
    summary: String,
    #[serde(default)]
    prompt_hint: String,
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct SuggestClarificationsInput {
    content: String,
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct SuggestThreadLinkInput {
    content: String,
    #[serde(default)]
...
#[serde(rename_all = "camelCase")]
pub struct ThreadLinkSuggestion {
    #[serde(default)]
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct SuggestReportGapsInput {
    #[serde(default)]
    entries: Vec<ReportGapEntry>,
}

#[derive(Debug, Clone, Default, Serialize, Deserialize)]
pub struct SuggestedReportGaps {
    #[serde(default)]
    gaps: Vec<ReportGap>,
}
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct GeneratedReportContent {
    #[serde(default)]
    title: String,
    #[serde(default)]
    summary: String,
...
#[tauri::command]
pub async fn check_codex_cli(command: String) -> Result<String, String> {
...
#[tauri::command]
pub async fn generate_daily_memory_with_codex(
...
#[tauri::command]
pub async fn generate_weekly_report_with_codex(
...
#[tauri::command]
pub async fn generate_range_report_with_codex(
...
#[tauri::command]
pub async fn analyze_report_style_with_codex(
...
#[tauri::command]
pub async fn suggest_clarifications_with_codex(
...
#[tauri::command]
pub async fn suggest_thread_link_with_codex(
...
#[tauri::command]
pub async fn suggest_report_gaps_with_codex(
